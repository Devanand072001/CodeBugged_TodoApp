...
import 'package:todo/service/email.dart';
            ...
            child: Column(
              children: [
                Container(height: 100,
                  child: Center(
                    child: Text('Todo App',style: TextStyle(fontSize: 48.0,fontWeight: FontWeight.bold),),),
                ),
...
SizedBox(height: 25,),
                ...
                RaisedButton(onPressed: () async{
                  getData();
                }, child: Text('Display all'),color: Colors.amberAccent,),
                SizedBox(height: 10,),
                RaisedButton(onPressed: (){
                  _todoHelper.deleteAllTask();
                  getData();
                }, child: Text('Clear all'),color: Colors.indigoAccent,),
